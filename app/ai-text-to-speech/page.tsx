...
const QUALITY = [
  { title: 'Text to Speech with Emotion', tag: '9 emotion styles', stat: '9' },
  { title: 'Natural Text to Speech Pacing', tag: 'MiniMax Speech 2.8 HD', stat: '#1' },
  { title: 'Clear Pronunciation Across Accents', tag: '20+ language variants', stat: '20+' },
  { title: 'Speed and Pitch Control', tag: '0.5× to 2.0× speed', stat: '2×' },
  { title: '50+ Distinct AI Voices', tag: '50+ voices', stat: '50+' },
  { title: 'Benchmark-Leading TTS Model', tag: 'Top benchmark score', stat: '#1' },
]
